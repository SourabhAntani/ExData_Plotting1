...
dt[,date_colleted := as.Date(Date, format = '%d/%m/%Y')];

hist(as.numeric(as.character(dt$Global_active_power)), xlab = 'Global Active Power (kilowatts)', col = 'red', main = "Global Active Power");
